...
import { RoutingAppPages, RoutingQuizPages } from '@app/config/routing';
...
export class QuestionService {
  ...
  fetchQuestion(questionId?: string): Observable<IQuestion> {
    ...
    if (!questionId) {
      ...
      if (!randomQuestionId) {
        this.router.navigate([RoutingAppPages.Quiz, RoutingQuizPages.Summary], { skipLocationChange: true });
